...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Charlotte', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一个好人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-hkui0h4w0-charlotte-zhangs-projects.vercel.app/', // 网站地址
  ...
  RANDOM_IMAGE_REPLACE_TEXT:
    ...
    'https://ibb.co/Pwj58qq', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://ibb.co/Pwj58qq', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
